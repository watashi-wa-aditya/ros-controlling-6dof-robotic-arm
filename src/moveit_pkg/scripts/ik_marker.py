...
def processFeedback(feedback):
    ...
    if feedback.event_type == InteractiveMarkerFeedback.MENU_SELECT:
        if feedback.menu_entry_id==1:
            ...
            listener.waitForTransform('/gripper','/base',rospy.Time(), rospy.Duration(1.0))
            (trans,rot)=listener.lookupTransform('base','gripper',rospy.Time())
            print(trans,rot)
...
if __name__=="__main__":
	...
	print(listener.frameExists('gripper'))
	(trans,rot)=listener.lookupTransform('base','gripper',rospy.Time())
	print(trans,rot)
